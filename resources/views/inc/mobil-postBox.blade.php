    ...
    <div class="post-item-wrap">
        <div class="post-image">
            <a href="/{{str_slug($bVal->title,"-")}}/{{$bVal->id}}.html">
                <div class="mansetright" style="background:url('@isset($bVal->files[0]->file){{HomepageController::webps($bVal->files[0]->file,"l")}}@endisset') center center; background-size:cover; height: {{$height}}px"></div>
            </a>
        </div>
